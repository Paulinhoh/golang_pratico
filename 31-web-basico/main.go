...
func main() {
	...
	http.HandleFunc("/summaries/", summmaryHandler)
...
func summmaryHandler(w http.ResponseWriter, r *http.Request) {
...
func getSummary(w http.ResponseWriter, id int) {
	...
	http.Error(w, "Summatry not found", http.StatusNotFound)
}
